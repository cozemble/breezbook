...
import { couponCode, environmentId, tenantEnvironment, tenantId } from '@breezbook/packages-types';
...
export const today = isoDateFns.today(timezones.utc);
export const tomorrow = isoDateFns.addDays(today, 1);
export const twoDaysFromNow = isoDateFns.addDays(today, 2);
export const threeDaysFromNow = isoDateFns.addDays(today, 3);
export const fourDaysFromNow = isoDateFns.addDays(today, 4);
export const fiveDaysFromNow = isoDateFns.addDays(today, 5);
...
export function everythingForCarWashTenantWithDynamicPricing(bookings: Booking[] = [], today = isoDateFns.today(timezones.utc), otherDays: IsoDate[] = []) {
