...
const customers = {
  ...
  requiredForInsert: ['id', 'tenant_id', 'first_name', 'last_name', 'email'],
  primaryKey: 'id',
  foreignKeys: { tenant_id: { table: 'tenants', column: 'tenant_id', $type: null as unknown as Tenants }, },
...
const order_lines = {
  ...
  columns: ['id', 'tenant_id', 'order_id', 'service_id', 'add_on_ids', 'date', 'time_slot_id', 'start_time_24hr', 'service_form_data'],
  requiredForInsert: ['id', 'tenant_id', 'order_id', 'service_id', 'date'],
  primaryKey: 'id',
  foreignKeys: { tenant_id: { table: 'tenants', column: 'tenant_id', $type: null as unknown as Tenants }, },
...
const orders = {
  ...
  requiredForInsert: ['id', 'tenant_id', 'customer_id'],
  primaryKey: 'id',
  foreignKeys: {
    tenant_id: { table: 'tenants', column: 'tenant_id', $type: null as unknown as Tenants },
    customer_id: { table: 'customers', column: 'id', $type: null as unknown as Customers },
