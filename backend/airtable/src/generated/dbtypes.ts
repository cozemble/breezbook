 ...
 * $ pg-to-ts generate -c postgresql://username:password@127.0.0.1:5432/postgres -t add_on -t blocked_time -t bookings -t business_hours -t customers -t dataversion -t pricing_rules -t resource_availability -t resource_blocked_time -t resource_types -t resources -t schemaversion -t services -t tenants -t time_slots -s public
 *
 */
...
const customers = {
  tableName: 'customers',
  columns: ['id', 'tenant_id', 'name', 'email', 'extra_details'],
...
const services = {
  tableName: 'services',
  columns: ['id', 'tenant_id', 'service_id', 'name', 'description', 'duration_minutes', 'price', 'price_currency', 'permitted_add_on_ids', 'resource_types_required', 'requires_time_slot'],
