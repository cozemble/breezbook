...
const wax = addOn('Wax', price(1000, GBP), false, addOnId('addOn-wax'));
const polish = addOn('Polish', price(500, GBP), false, addOnId('addOn-polish'));
const cleanSeats = addOn('Clean seats', price(2000, GBP), true, addOnId('addOn-clean-seats'));
const cleanCarpets = addOn('Clean carpets', price(2000, GBP), false, addOnId('addOn-clean-carpets'));
