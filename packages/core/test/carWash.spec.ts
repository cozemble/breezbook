...
const config = businessConfiguration(availability, carwash.resources,resourceAvailability, carwash.services, [], carwash.timeslots, [], periodicStartTime(duration(minutes(30))), null);
