...
export const load: PageServerLoad = async () => {
    return {
        ...
        description: "Easily book professional dog walking services with Breez Walks. Choose your service, time, and options all in one place!  This is a demo of the Breezbook booking platform.",
